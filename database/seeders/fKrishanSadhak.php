...
class fKrishanSadhak extends Seeder
{
    public function run(): void
    {
        $filePath = public_path('ExcelData/resultSeeder/KrishanSadhak.xlsx'); // Path to the uploaded file
