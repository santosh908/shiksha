...
class fShrilaPrabhupadaAshray extends Seeder
{
    public function run(): void
    {
        $filePath = public_path('ExcelData/resultSeeder/fShrilaPrabhupadaAshray.xlsx'); // Path to the uploaded file
