...
use App\Mail\DevoteeApprovedMail;
use App\Models\User;
...
class DevoteeApprovedJob implements ShouldQueue, ShouldBeUnique
{
    ...
    private function sendEmail($data)
    {
        ...
        Mail::to($email)->send(new DevoteeApprovedMail($name, $email,$LoginID));
        return;
    }
