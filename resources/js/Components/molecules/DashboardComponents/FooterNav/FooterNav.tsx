import { ActionIcon, Button, ButtonProps, Group, Menu, rem, Text, useMantineColorScheme, useMantineTheme } from '@mantine/core';
...
const FooterNav = () => {
  ...
  return (
    <Group  justify="center">
      ...
      <Text c="dimmed" style={{textAlign:"center"}} fz="sm" component="a" target="_blank">
        &copy;&nbsp;{new Date().getFullYear()}&nbsp;ISKCON
      </Text>
    </Group>
  );
};
