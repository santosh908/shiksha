...
const columns = [
  ...
  { name: 'Ashery Leader Name', selector: (row: devoteeNextLeveType) => row.ashray_leader_initiated_name || row.ashery_leader_name, sortable: true },
  { name: 'Bhakti Vriksha Leader Name', selector: (row: devoteeNextLeveType) => row.bhakti_leader_initiated_name || row.bhakti_bhikshuk_name, sortable: true },
  { name: 'Name', selector: (row: devoteeNextLeveType) => row.name, sortable: true, },
  { name: 'Initiated Name', selector: (row: devoteeNextLeveType) => row.Initiated_name, sortable: true, },
  ...
  {name:'Gurupada Ashray Written Obtain', selector: (row: devoteeNextLeveType) => row.level_7_obtained_marks, sortable: true },
  {name:'Gurupada Total Obtain',selector:(row:devoteeNextLeveType) =>(Number(row.level_7_obtained_marks || 0) + Number(row.level_6_obtained_marks || 0)), sortable:true},
