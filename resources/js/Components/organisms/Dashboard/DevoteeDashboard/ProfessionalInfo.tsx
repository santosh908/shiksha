...
import { IconArrowLeft, IconArrowRight, IconCalendar, IconSend } from '@tabler/icons-react';
...
export default function ProfessionalInfo({ masterData, handleBack, handleNext, containerStyle }: ProfessionalInfoPropos) {
  ...
  const handleSubmit = () => {
    router.post('/Devotee/ProfessionalInfo', form.values);
  };
  ...
  return (
    <>
      ...
      <Grid py={10}>
        ...
        >
          <label style={containerStyle}>Please check the regulaterly principle you are following? कृपया वह नियमित सिद्धांत चुनें जिसे आप मान रहे हैं?</label>
          <Checkbox.Group
            withAsterisk
        ...
        >
          <label style={containerStyle}>Please check the Srila Prabhupads's books that you have readm - कृपया श्रील प्रभुपाद की किताबें चेक करें जिन्हें आपने पढ़ा है</label>
