...
export default function HearingReading({ masterData, handleNext, handleBack, containerStyle }: HearingReadingProps) {
  const form = useForm({
    initialValues: {
  ...
  const handleSubmit = () => {
    router.post('/Devotee/HearingReading', form.values);
  };
  ...
  return (
    <>
      ...
      <Grid py={10}>
        <Grid.Col span={{ base: 12, md: 12, lg: 12 }}>
          <label style={containerStyle}>Which of the following seminars have you attended ? - निम्नलिखित में से आपने कौन से सेमिनार में भाग लिया है?</label>
